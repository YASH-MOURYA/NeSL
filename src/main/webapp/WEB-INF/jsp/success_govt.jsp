...
<head>
    <meta charset="UTF-8">
    <title>Govt Entity Login Success</title>
    <style>
        ...
        .badge { margin-top: 18px; display: inline-block; padding: 12px 24px; background: #34495e; border-radius: 999px; font-weight: 700; }
...
<div class="page">
    <div class="card">
        <h1>Govt Entity Dashboard</h1>
        <p>You are logged in as a Statutory / Govt Entity.</p>
        <p>Category: <strong>${loginType}</strong></p>
        <div class="badge">Govt Entity Access</div>
        <div>
