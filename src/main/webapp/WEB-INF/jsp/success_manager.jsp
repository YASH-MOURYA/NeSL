...
<head>
    <meta charset="UTF-8">
    <title>Manager Login Success</title>
    <style>
...
<div class="page">
    <div class="card">
        <h1>Manager Login Success</h1>
        <p>Hello, <strong>${userId}</strong>. You are signed in with manager privileges.</p>
        <p>Login Type: <strong>${loginType}</strong></p>
        <p>Your UIN / PAN is <strong>${uin}</strong>.</p>
        <div class="badge">Manager Access</div>
        <div>
